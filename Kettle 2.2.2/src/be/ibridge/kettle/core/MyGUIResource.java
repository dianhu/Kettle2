...
{
    private static MyGUIResource MyGUIResource;
    ...
    private MyGUIResource(Display display)
    {
    ...
    public static final MyGUIResource getInstance()
    {
        if (MyGUIResource!=null) return MyGUIResource;
        MyGUIResource = new MyGUIResource(Props.getInstance().getDisplay());
        return MyGUIResource;
    }
